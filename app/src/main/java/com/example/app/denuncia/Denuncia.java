...
public class Denuncia {
    ...
    public static DenunciaReturnDTO covDenunciaReturnDTO(Denuncia d){
        return new DenunciaReturnDTO(d.getIdentifier(),d.getNome(),d.getDataEnchente(),d.getLocal(),d.getRelato(),d.getImageURL(),d.getMmChovido(),d.getPrevisao(),d.getDataDenuncia());
    }
